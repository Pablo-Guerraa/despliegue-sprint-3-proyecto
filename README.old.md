# 👋 Bienvenido al Proyecto Final del Sprint 3

**En este proyecto buscamos que logres evidenciar tus conceptos avanzados de fundamentos web, haciendo uso de React JS y Redux.
Además que sustentar los conocimientod adquiridos haciendo uso de marcos de trabajo CSS, manejo de estados con React Redux y realizar Single Page Application**
...
[Recursos Proyecto Final Sprint 3](https://drive.google.com/drive/folders/1XnrwL-KHNhus5ygcfu506GRvtEzua1te?usp=sharing)
...
1. Crear un `Issue` llamado **Entrega-Frontend-Sprint3-Proyecto**
...
4. Generar la URL de despliegue y relacionarla en el `Issue` **Entrega-Frontend-Sprint3-Proyecto**
